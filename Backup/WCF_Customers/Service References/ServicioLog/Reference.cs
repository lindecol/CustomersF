...
namespace WCF_Customers.ServicioLog {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.praxair.com.co", ConfigurationName="ServicioLog.IUtilities")]
    public interface IUtilities {
        ...
        WCF_Customers.ServicioLog.clsResponse[] GetErrors(WCF_Customers.ServicioLog.ProcessId processId, int itemId);
        ...
        void InsertError(int staggingId, int errorId, WCF_Customers.ServicioLog.ProcessId processId, string description);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IUtilitiesChannel : WCF_Customers.ServicioLog.IUtilities, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UtilitiesClient : System.ServiceModel.ClientBase<WCF_Customers.ServicioLog.IUtilities>, WCF_Customers.ServicioLog.IUtilities {
        ...
        public WCF_Customers.ServicioLog.clsResponse[] GetErrors(WCF_Customers.ServicioLog.ProcessId processId, int itemId) {
            return base.Channel.GetErrors(processId, itemId);
        }
        
        public void InsertError(int staggingId, int errorId, WCF_Customers.ServicioLog.ProcessId processId, string description) {
